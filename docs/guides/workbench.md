...
3. **Chat**, **Mail**, or another product area: Read and change provider state.
4. **Activity**: See events that result from API and Workbench changes.
...
ledger. It keeps PostgreSQL and MySQL application data. Read the scope in the
