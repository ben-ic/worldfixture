...
export function App() {
  ...
  const screens = {
    ...
    Settings: <Settings data={data} onReset={() => setResetOpen(true)}/>, Services: <Services data={data}/>,
    Chat: <Chat {...common}/>, Gmail: <Gmail {...common}/>, Mail: <Mail {...common}/>, Code: <Code {...common}/>, Files: <Files {...common}/>, Notion: <Notion {...common}/>, Website: <Website data={data}/>,
  };
  ...
  return <>
    ...
    <FirstRunGuide open={guideOpen} setOpen={setGuideOpen} connectedSeen={visited.includes("Target")} setScreen={navigate} activityCount={data.activity.length} resetProven={Boolean(proof?.startsWith("Accepted starting state returned"))}/>
