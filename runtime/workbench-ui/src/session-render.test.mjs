...
const server = await createServer({ root: resolve(dirname(fileURLToPath(import.meta.url)), '..'), server: { middlewareMode: true, hmr: false, ws: false, watch: null }, logLevel: 'silent' });
after(() => server.close());
